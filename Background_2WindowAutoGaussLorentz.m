...
fitfunctionwin(1,:) = (ft(1)*(1-ft(2))*exp(-(((fitEN(1,:)-(ft(3)))/ft(4)).^2))+lorentz(fitEN(1,:),ft(1)*(ft(2)),ft(3),ft(5))+ft(6));
...
fitfunction(1,:) = ft(1)*(1-ft(2))*exp(-(((EN(1,:)-(ft(3)))/ft(4)).^2))+lorentz(EN(1,:),ft(1)*(ft(2)),ft(3),ft(5))+ft(6);
